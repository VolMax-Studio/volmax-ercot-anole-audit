#!/usr/bin/env python3
"""Publish the ERCOT Anole BESS audit to Zenodo.
...
Usage:
    python publish_zenodo.py --version 1.0.1 --dry-run
    python publish_zenodo.py --version 1.0.1
"""
import argparse
import glob
import json
...
CORE_FILES = [
    ...
    "l1_integrity.py",
    "publish_zenodo.py",
    "audits/US-TX-ANOL-001/audit_prep.md",
    "audits/US-TX-ANOL-001/data_manifest.json",
    "audits/US-TX-ANOL-001/findings.md",
    "audits/US-TX-ANOL-001/l1_flags.json",
    "audits/US-TX-ANOL-001/l1_report.md",
    "audits/US-TX-ANOL-001/metrics.json",
    "audits/US-TX-ANOL-001/report.md",
    "audits/US-TX-ANOL-001/selection_rationale.md",
    "audits/US-TX-ANOL-001/sources.md",
    "results/panel1_feb11_event.png",
...
def main():
    ...
    ap.add_argument("--version", required=True, help="e.g. 1.0.1")
